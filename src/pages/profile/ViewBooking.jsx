      ...
      <div className="mx-[7vw] my-5">
        ...
        <div className="flex justify-between h-10 items-center mb-3 p-2 rounded-lg border">
          <div className="flex h-full w-full justify-between">
            <button className="py-2  w-1/3 px-6  text-gray-600 border-b-2 border-blue-900">
              Upcoming
            </button>
            <button className="py-2 w-1/3  px-6 bg-white text-gray-600 border-l-2 border-slate-300 ">
              Completed
            </button>
            <button className="py-2 w-1/3  px-6 bg-whitetext-gray-600 border-l-2 border-slate-300">
              Cancelled
            </button>
          </div>
        </div>
